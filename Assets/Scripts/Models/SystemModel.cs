...
namespace LunraGames.SubLight.Models
{
	public class SystemModel : Model
	{
		...
		[JsonIgnore] public readonly ListenerProperty<SpecifiedEncounterEntry[]> SpecifiedEncounters;
		...
		public SystemModel()
		{
			...
			PrimaryClassification = new ListenerProperty<SystemClassifications>(
				value => KeyValues.Set(KeyDefines.CelestialSystem.ClassificationPrimary, value),
				() => KeyValues.Get(KeyDefines.CelestialSystem.ClassificationPrimary)
			);
