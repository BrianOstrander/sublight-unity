...
namespace LunraGames.SpaceFarm.Presenters
{
	public class ShipSystemPresenter : Presenter<IShipSystemView>, IPresenterCloseShow
	{
		...
		{
			var rationsConsumed = model.Ship.Value.Resources.Rations.Value - (delta.Delta.TotalTime * model.Ship.Value.RationConsumption);
			model.Ship.Value.Resources.Rations.Value = Mathf.Max(0f, rationsConsumed);
