...
namespace LunraGames.SubLight
{
	public class EncounterService
	{
		...
		public void AssignBestEncounter(Action<AssignBestEncounter> done, GameModel model, SystemModel system)
		{
			...
			var remaining = encounters.Where(
				e =>
				{
					...
					switch (model.Context.EncounterState.GetEncounterStatus(e.EncounterId).State)
					{
		...
		)
		{
			...
			model.Context.EncounterState.SetEncounterStatus(EncounterStatus.Seen(chosen.EncounterId));
