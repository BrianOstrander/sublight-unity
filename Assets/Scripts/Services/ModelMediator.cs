	...
	public abstract class ModelMediator : IModelMediator
	{
		...
		protected Type ToType(SaveTypes saveType)
		{
			switch(saveType)
			{
				...
				// -- Procedural Noise
				case SaveTypes.ProceduralNoise: return typeof(ProceduralNoiseModel);
				// --
		...
		protected SaveTypes[] ToEnum(Type type)
		{
			...
			// -- Procedural Noise
			if (type == typeof(ProceduralNoiseModel)) return new SaveTypes[] { SaveTypes.ProceduralNoise };
			// --
		...
		protected string GetUniqueIdKey(SaveTypes saveType)
		{
			switch (saveType)
			{
				...
				case SaveTypes.ProceduralNoise: return MetaKeyConstants.ProceduralNoise.ProceduralNoiseId;
				default:
